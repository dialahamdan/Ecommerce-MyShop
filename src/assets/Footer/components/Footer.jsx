          ...
          <div className="col mb-3 rightSide  ">
            ...
            <div className="ms-3 mt-3">
              <Link
                ...
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/diala.hamdan.357?mibextid=kFxxJD",
                    "_blank"
                  )
                }
              >
              ...
              <Link
                ...
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/diala_.hamdan?igsh=ODltZXVsczgwdnBn",
                    "_blank"
                  )
                }
              >
              ...
              <Link
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/diala-hamdan-092a23256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
                    "_blank"
                  )
                }
              >
